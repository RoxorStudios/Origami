		...
		<div class="form-group">
			...
			<div class="submodules">
				<div class="box">
					...
					<p class="m-b-3">@lang('origami::module.list.empty')</p>
					@else
					@include('origami::entries.partials.entries_table',['module'=>$module,'entries'=>$entries])
					@endif

					<button type="button" v-on:click="addEntryToSubmodule('{{ $field->uid }}')" class="button button-tiny m-t-3"><i class="fa fa-plus"></i> @lang('origami::global.add')</button>
				</div>
			</div>
		</div>
	</div>
